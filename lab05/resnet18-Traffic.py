...
if __name__ == '__main__':
    ...
    # Assuming 'traffic_signs' is the directory containing 'train' and 'test' folders
    ...
    # define model
    model = resnet18(num_classes=len(train_set.classes)).to(device)
    ...
    #初始化学习率调度器
    scheduler = MultiStepLR(optimizer, milestones=[20, 30, 40], gamma=0.1)  # 每10个epoch将学习率降低到原来的0.1
    ...
    torch.save(model.state_dict(), 'traffic_model_params.pth')
